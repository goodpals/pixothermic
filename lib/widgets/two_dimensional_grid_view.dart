...
class RenderTwoDimensionalGridViewport extends RenderTwoDimensionalViewport {
  ...
  void layoutChildSequence() {
    ...
    final int leadingColumn =
        math.max((horizontalPixels / itemSize).floor(), 0);
    ...
    double xLayoutOffset = (leadingColumn * itemSize) - horizontalOffset.pixels;
    for (int column = leadingColumn; column <= trailingColumn; column++) {
      double yLayoutOffset = (leadingRow * itemSize) - verticalOffset.pixels;
      for (int row = leadingRow; row <= trailingRow; row++) {
        ...
        // Subclasses only need to set the normalized layout offset. The supers
